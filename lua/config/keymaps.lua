...
map("n", "<leader>lA", ":lua vim.lsp.buf.range_code_action()<CR>", default_opts)
...
--git
map("n", "<leader>[", ":Gitsigns prev_hunk<CR>", default_opts)
map("n", "<leader>]", ":Gitsigns next_hunk<CR>", default_opts)
map("n", "<leader>ga", ":Gitsigns stage_hunk<CR>", default_opts)
map("n", "<leader>gA", ":Gitsigns stage_buffer<CR>", default_opts)
map("n", "<leader>gu", ":Gitsigns undo_stage_hunk<CR>", default_opts)
map("n", "<leader>gU", ":Gitsigns reset_buffer_index<CR>", default_opts)
map("n", "<leader>gc", ":Git commit | only<CR>", default_opts)
map("n", "<leader>gC", ":Git commit --amend | only<CR>", default_opts)
map("n", "<leader>gp", ":Git push<CR>", default_opts)
map("n", "<leader>gP", ":Git push --force<CR>", default_opts)
